            ...
            <section className="w-full pt-10">
...

                {
                    carports && carports?.map(c => (
                        <div data-aos="fade-up" data-aos-duration="1000" className="flex flex-col md:flex-row justify-between py-7 items-center w-full gap-5">
                            <div className="w-full md:w-3/6 mx-auto relative">
                                <img src={c?.images?.banner} alt="Style Meets Shelter for Your Vehicle, Order your Carport right now!" className="relative shadow-lg w-full h-64 md:h-80 lg:h-96 border border-primary rounded-2xl object-cover z-10" loading='eager' />
