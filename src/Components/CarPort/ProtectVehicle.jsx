        ...
        <div className="container bg-white h-full px-7 pt-7 mx-auto w-full text-black">
            <div className='flex h-full flex-col md:flex-row justify-between gap-3 py-10 items-center'>
                ...
                <div className='w-full md:w-3/6 mx-auto'>
                    <img className="w-full h-full md:h-96 object-cover border border-primary" src="https://i.ibb.co/6XSDYLq/Whats-App-Image-2023-0f5-14-at-19-06-13-1.jpg" loading="eager" alt="Carport" />
                </div>
            </div>
        </div>
    );
